...
define('FILE_VERSION', '4.2.3'); // this should match installsteps.php
define('SIMPLE_VERSION', '423'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 84923 $
* @date		$Date: 2015-06-11 18:33:54 -0700 (Thu, 11 Jun 2015) $
*/
class vB_Database
{
	/**
